...
-(void)getProductCategories{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=product-categories&parent=0",[[AppDelegate instance] getDatabaseURL]];
...
-(void)getHomePageApi{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=home-appearance-api",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(void)getFeaturedProducts{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=get-featured-product",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(void)getRandomProducts{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=get-random-items",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(void)getRecentItems{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=get-recent-items",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(void)getProductCategoriesCustom{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=custom-category-appearance-api",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(void)deviceIDSend:(NSString*)deviceID device:(NSString*)deviceName{
    ...
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=analytics&type=insert",[[AppDelegate instance] getDatabaseURL]]]];
...
-(void)updatePushNotification:(NSString*)deviceID pushtoken:(NSString*)pushtoken{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=analytics&type=update",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(void)getLeftMenuData{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=wp-menu-json-api&type=menu&slugname=CandyCartPushLeftMenu",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getBussinessDirectoryPlugin{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=wp-post-api&type=get-business-directory-listing",[[AppDelegate instance] getDatabaseURL]];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getWpPostByPostID:(NSString*)postID{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=wp-post-api&type=get-single-post&postID=%@",[[AppDelegate instance] getDatabaseURL],postID];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getPostByCategory:(NSString*)catID currentPage:(NSString*)currentPage postPerPage:(NSString*)post_per_page{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=wp-post-api&type=get-post-by-category-id&catID=%@&currentPage=%@&post_per_page=%@",[[AppDelegate instance] getDatabaseURL],catID,currentPage,post_per_page];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)get_search_post:(NSString*)keyword currentPage:(NSString*)currentPage postPerPage:(NSString*)post_per_page{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=wp-post-api&type=search-post&keyword=%@&currentPage=%@&post_per_page=%@",[[AppDelegate instance] getDatabaseURL],keyword,currentPage,post_per_page];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getCommentByCommentID:(NSString*)commentID{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=get-comment-by-id&commentID=%@",[[AppDelegate instance] getDatabaseURL],commentID];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)comment_follow:(NSString*)username password:(NSString*)password commentID:(NSString*)commentID type:(NSString*)type{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=comment-follow&type=%@",[[AppDelegate instance] getDatabaseURL],type]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)getSinglePaymentGatewayMetaKey:(NSString*)key{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=get-single-payment-gateway-meta&key=%@",[[AppDelegate instance] getDatabaseURL],key];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSArray*)getChildProductCategories:(NSString*)parentID{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=product-categories&parent=%@",[[AppDelegate instance] getDatabaseURL],parentID];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getProductByCategory:(NSString*)categoryID page:(NSString*)page productPerPage:(NSString*)productPerPage{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=product-by-category-id&id=%@&page=%@&products-per-page=%@",[[AppDelegate instance] getDatabaseURL],categoryID,page,productPerPage];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getProductByKeyword:(NSString*)keyword page:(NSString*)page productPerPage:(NSString*)productPerPage{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=search-product&keyword=%@&page=%@&products-per-page=%@",[[AppDelegate instance] getDatabaseURL],keyword,page,productPerPage];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)getSingleProduct:(NSString*)postID{
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=single-product&id=%@",[[AppDelegate instance] getDatabaseURL],postID];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
...
-(NSDictionary*)get_my_order:(NSString*)username password:(NSString*)password filter:(NSString*)filter{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=get-my-order",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)user_logout{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=user-logout",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)sign_up:(NSString*)username email:(NSString*)email first_name:(NSString*)first_name last_name:(NSString*)last_name password:(NSString*)password{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=user-registration",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)get_single_order:(NSString*)username password:(NSString*)password orderID:(NSString*)orderID{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=get-order",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)profile_update:(NSString*)username password:(NSString*)password arg:(NSMutableDictionary*)arg{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=user-profile-update",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)profileImageUpdate:(NSString*)username password:(NSString*)password imageData:(NSData*)imageData{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=json-api&type=user-profile-image-update",[[AppDelegate instance] getDatabaseURL]];
...
-(NSDictionary*)billing_update:(NSString*)username password:(NSString*)password arg:(NSMutableDictionary*)arg{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=user-billing-update",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)shipping_update:(NSString*)username password:(NSString*)password arg:(NSMutableDictionary*)arg{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=user-shipping-update",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)post_comment:(NSString*)username password:(NSString*)password arg:(NSMutableDictionary*)arg{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=user-post-comment",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)reviewCartWithCoupon:(NSString*)username password:(NSString*)password productInJsonString:(NSString*)productInJsonString coupon:(NSString*)couponCodeInJsonString{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=cart-api",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)placeAnOrder:(NSString*)username password:(NSString*)password productInJsonString:(NSString*)productInJsonString coupon:(NSString*)couponCodeInJsonString paymentMethodID:(NSString*)paymentMethod orderNotes:(NSString*)orderNotes{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=place-an-order-api",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)change_password:(NSString*)username password:(NSString*)password newpassword:(NSString*)newpassword{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/?candycart=json-api&type=change-password",[[AppDelegate instance] getDatabaseURL]]]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(NSDictionary*)qrcodescanner:(NSString*)string{
    ...
    NSString *urlString = [NSString stringWithFormat:@"%@/?candycart=qrcode-api&link=%@",[[AppDelegate instance] getDatabaseURL],string];
    NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:urlString]];
