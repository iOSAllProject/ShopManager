...
-(void)gridStyleOnSale:(NSString*)url title:(NSString*)str priceRegular:(NSString*)regularPrice salePrice:(NSString*)salePrice productInfo:(NSDictionary*)productInfo{
    ...
    box.onTap = ^{
        AddPushNotificationViewController *controller = (AddPushNotificationViewController*)[[self.navigationController viewControllers] objectAtIndex:2];
        [controller setCurrentProductInfo:productInfo];
